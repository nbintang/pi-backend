...
export namespace Prisma {
  ...
  */
  ...
  export type MeatOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "image" | "confidence" | "rawProbability" | "category" | "createdAt", ExtArgs["result"]["meat"]>
  ...
  interface MeatFieldRefs {
    readonly id: FieldRef<"Meat", 'String'>
    readonly name: FieldRef<"Meat", 'String'>
    readonly image: FieldRef<"Meat", 'String'>
    readonly confidence: FieldRef<"Meat", 'Float'>
    readonly rawProbability: FieldRef<"Meat", 'Float'>
    readonly category: FieldRef<"Meat", 'Category'>
  ...
  export type MeatWhereInput = {
    ...
    id?: StringFilter<"Meat"> | string
    name?: StringFilter<"Meat"> | string
    image?: StringNullableFilter<"Meat"> | string | null
    confidence?: FloatFilter<"Meat"> | number
    rawProbability?: FloatFilter<"Meat"> | number
    category?: EnumCategoryFilter<"Meat"> | $Enums.Category
  ...
  export type MeatScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter<"Meat"> | string
    name?: StringWithAggregatesFilter<"Meat"> | string
    image?: StringNullableWithAggregatesFilter<"Meat"> | string | null
    confidence?: FloatWithAggregatesFilter<"Meat"> | number
    rawProbability?: FloatWithAggregatesFilter<"Meat"> | number
    category?: EnumCategoryWithAggregatesFilter<"Meat"> | $Enums.Category
  ...
  export type MeatUpdateInput = {
    ...
    rawProbability?: FloatFieldUpdateOperationsInput | number
